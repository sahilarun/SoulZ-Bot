module.exports = {
  ...
  embed: {
    ...
    wrongcolor: process.env.wrongcolor || "",
    footertext: "",
    footericon: " ",
  },
  emoji: {
  ...
  // others
  guildID: process.env.guildID || "1023447832398663742", // for slash command
  mongodb : process.env.mongodb || "mongodb+srv://Zone:Zone@cluster0.z2bwm.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",
  filters: {
